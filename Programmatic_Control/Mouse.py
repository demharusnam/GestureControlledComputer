from Programmatic_Control.WINDOWS_API_STRUCTS import UINT, LONG, DWORD, ULONG_PTR, INPUT_MOUSE
from Programmatic_Control.WINDOWS_API_STRUCTS import MOUSEINPUT, DUMMYUNIONNAME, INPUT, LPINPUT, INPUT_BYTES
from Programmatic_Control.WINDOWS_API_STRUCTS import windll
from Programmatic_Control.WINDOWS_VIRTUAL_KEY_CODES import VK_LBUTTON, VK_RBUTTON
